...
class TestingTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        testingTableView.register(UINib(nibName: "AudioTableViewCell", bundle: nil) , forCellReuseIdentifier: "audioCell")
      
      //  testingTableView.automaticallyAdjustsScrollIndicatorInsets
        
        testingTableView.delegate = self
        testingTableView.dataSource = self
        testingTableView.rowHeight = UITableView.automaticDimension
        testingTableView.estimatedRowHeight = 600

        testingTableView.reloadData()
